...
**Parameters:**
  ...
  * **bet_type (integer, required):** 0 for Bullish CFD (legacy), 1 for Bearish CFD (legacy), 2 for Equal, 3 for NotEqual.
...
* **bet_type** (*integer*): 0 for Bullish CFD (legacy), 1 for Bearish CFD (legacy), 2 for Equal, 3 for Not Equal
...
* **tx0_bet_type** (*string*): The type of the initial bet (0 for Bullish CFD (legacy), 1 for Bearish CFD (legacy), 2 for Equal, 3 for Not Equal)
...
* **tx1_bet_type** (*string*): The type of the counter bet (0 for Bullish CFD (legacy), 1 for Bearish CFD (legacy), 2 for Equal, 3 for Not Equal)
...
* **bet_matches**: pending, settled, settled: for equal, settled: for notequal, dropped, expired
